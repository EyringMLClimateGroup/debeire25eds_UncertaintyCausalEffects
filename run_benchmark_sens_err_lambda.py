...
if __name__=="__main__":
    ...
    dfmode_mrae.to_csv("./output/%s_LTE_MRAE.csv"%varying_parameter)
    dfmode_links.to_csv("./output/%s_Links_MSE.csv"%varying_parameter)
    dfmode_sens_err.to_csv("./output/%s_Sensitivity_Error.csv"%varying_parameter)
