...
if __name__=="__main__":
    ...
    dfauto_mrae.to_csv("./output/%s_LTE_MRAE.csv"%varying_parameter)
    dfauto_links.to_csv("./output/%s_Links_MSE.csv"%varying_parameter)
    dfauto_sens_err.to_csv("./output/%s_Sensitivity_Error.csv"%varying_parameter)
