...
if __name__=="__main__":
    ...
    dfL_mrae.to_csv("../results/%s_LTE_MRAE.csv"%varying_parameter)
    dfL_links.to_csv("../results/%s_Links_MSE.csv"%varying_parameter)
    dfL_sens_err.to_csv("../results/%s_Sensitivity_Error.csv"%varying_parameter)